...
codes = [{"code":"15429","system":"gprdproduct"},{"code":"3110","system":"gprdproduct"},{"code":"20966","system":"gprdproduct"},{"code":"18350","system":"gprdproduct"},{"code":"37696","system":"gprdproduct"}];
REQUIRED_CODES = 1;
